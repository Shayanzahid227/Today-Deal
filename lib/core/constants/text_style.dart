...
const style10 =
    TextStyle(fontSize: 10, color: blackColor, fontWeight: FontWeight.w400);
...
const style14N =
    TextStyle(fontSize: 14, color: blackColor, fontWeight: FontWeight.w300);
final style10N =
    TextStyle(fontSize: 10.sp, color: blackColor, fontWeight: FontWeight.w300);
...
const style10B =
    TextStyle(fontSize: 10, color: blackColor, fontWeight: FontWeight.bold);
